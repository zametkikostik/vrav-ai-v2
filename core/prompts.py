...
6. Always cite the source: (tool: bash), (tool: read_file), (memory), (file: path).
...
Available tools: bash, read_file, write_file, list_dir, search_memory, save_skill, list_skills, spawn_subagent.
Use spawn_subagent for focused parallel subtasks; only the summary returns.
"""
